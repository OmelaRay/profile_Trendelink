              ...
              <div className="flex-1 flex flex-col items-start justify-start gap-0.5 min-w-[583px] max-w-full mq750:min-w-full">
                <div className="self-stretch flex flex-col items-start justify-start py-0 pl-0 pr-[30px] box-border max-w-full">
                  <form className="m-0 self-stretch flex flex-row items-start justify-start relative max-w-full">
                    ...
                    />
                    <div className="flex-1 shadow-[3px_3px_10px_2px_rgba(108,_108,_108,_0.2)] rounded-xl bg-whitesmoke-100 flex flex-col items-start justify-start pt-[42px] px-0 pb-0 box-border gap-[117px] max-w-full z-[1] mq750:pt-[27px] mq750:box-border mq450:gap-[29px] mq1050:gap-[58px]">
                      ...
                      <div className="self-stretch flex flex-row items-start justify-start py-0 pl-[42px] pr-[45px] box-border max-w-full mq1050:pl-[21px] mq1050:pr-[22px] mq1050:box-border">
                        <div className="flex-1 flex flex-row items-start justify-start max-w-full [row-gap:20px] mq750:flex-wrap">
                          <div className="flex-1 flex flex-col items-start justify-start gap-[73px] min-w-[196px] mq450:gap-9">
                            <div className="self-stretch flex flex-col items-start justify-start gap-[42px] mq450:gap-[21px]">
                              ...
                              <div className="self-stretch flex flex-row items-start justify-start py-0 pl-0.5 pr-0">
                                <div className="flex-1 flex flex-row items-end justify-center [row-gap:20px] mq450:flex-wrap">
                                  <div className="flex-1 rounded-8xs bg-white flex flex-row items-start justify-center pt-3 pb-[13px] pl-[21px] pr-5 box-border min-w-[11px] z-[2]">
                            ...
                            <div className="w-[258px] flex flex-row items-start justify-start py-0 px-px box-border">
                              <div className="flex-1 flex flex-col items-start justify-start gap-[15px]">
                                ...
                                <div className="self-stretch flex flex-col items-start justify-start gap-[7px]">
                                  <a className="[text-decoration:none] relative text-sm font-inter text-text-2 text-center inline-block min-w-[83px] z-[4]">
                                    Новий Email
                                  </a>
                                  <div className="self-stretch flex flex-row items-start justify-start py-0 pl-px pr-0">
                                    <Input
                                      className="bg-[transparent] flex-1 font-inter font-extralight text-sm text-main-black z-[4]"
                                      bordered={true}
                                    />
                                  </div>
                                </div>
                          ...
                          <div className="w-[180px] flex flex-col items-start justify-start pt-[66px] px-0 pb-0 box-border">
                            <div className="self-stretch rounded-8xs bg-white border-silver-100 border-[1px] border-solid flex flex-row items-start justify-center pt-2.5 pb-[11px] pl-[21px] pr-5 z-[2]">
                              <div className="h-[54px] w-[180px] relative rounded-8xs bg-white border-silver-100 border-[1px] border-solid box-border hidden" />
