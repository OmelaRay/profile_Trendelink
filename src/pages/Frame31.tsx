...
const Frame31: FunctionComponent = () => {
  return (
                  ...
                  <div className="flex-1 flex flex-col items-start justify-start gap-[145px] max-w-full text-center text-2xs text-transparent mq450:gap-9 mq1050:gap-[72px]">
                    <div className="w-[748px] flex flex-row items-start justify-start py-0 px-[5px] box-border max-w-full">
                      <div className="flex-1 flex flex-row items-start justify-start flex-wrap content-start gap-[5px] max-w-full">
                        ...
                        <div className="w-[86px] rounded-8xs border-gainsboro-100 border-[1px] border-solid box-border overflow-hidden shrink-0 flex flex-row items-start justify-start py-0.5 px-3.5 gap-0.5 z-[1]">
                          <div className="w-[38px] flex flex-col items-start justify-start pt-0.5 px-0 pb-0 box-border">
                            <div className="self-stretch relative inline-block min-w-[38px]">
                              Статус
                            </div>
                          </div>
                          <img
                        ...
                        <div className="w-[97px] rounded-8xs border-gainsboro-100 border-[1px] border-solid box-border overflow-hidden shrink-0 flex flex-row items-start justify-start py-0.5 px-3.5 gap-0.5 z-[1]">
                        ...
                        <div className="w-[99px] rounded-8xs border-gainsboro-100 border-[1px] border-solid box-border overflow-hidden shrink-0 flex flex-row items-start justify-start py-0.5 px-3.5 gap-px z-[1]">
                          <div className="flex flex-col items-start justify-start pt-0.5 px-0 pb-0">
